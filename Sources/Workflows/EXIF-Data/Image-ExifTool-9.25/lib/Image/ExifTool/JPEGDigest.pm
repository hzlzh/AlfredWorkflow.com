...
# File:         JPEGDigest.pm
#
# Description:  Lookup for JPEGDigest values
#
...
Image::ExifTool::JPEGDigest - Lookup for JPEGDigest values
...
some image identification from JPEG data alone.
