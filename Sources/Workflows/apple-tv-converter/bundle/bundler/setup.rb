...
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/awesome_print-1.1.0/lib")
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/little-plugger-1.1.3/lib")
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/multi_json-1.7.3/lib")
