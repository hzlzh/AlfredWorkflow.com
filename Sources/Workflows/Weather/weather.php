...
if ( $location ) {
	...
	switch(trim($weather->weather)):
		...
		case 'Unknown Precipitation': $icon = 'icons/007.png'; break;
		case 'Unknown': $icon = 'icons/001.png'; break;
		default: $icon = 'icons/001.png'; break;
	endswitch;
	...
	if ( $unit == 'F' ):
		...
		$w->result( 'weather', 'http://www.wunderground.com'.$location, $weather->display_location->full.": ".$weather->weather, $weather->temp_c.'°C ('.$weather->temp_f.'°F)' , $icon );
	endif;
